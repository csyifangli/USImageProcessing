...
%%
load 1\maximums\10\maximums3.mat;
maximumsCell{1,9} = maximums;
load 1\maximums\10\maximums6.mat;
maximumsCell{1,8} = maximums;
load 1\maximums\10\maximums9.mat;
maximumsCell{1,7} = maximums;
load 1\maximums\10\maximums12.mat;
maximumsCell{1,6} = maximums;
load 1\maximums\10\maximums15.mat;
maximumsCell{1,5} = maximums;
load 1\maximums\10\maximums27.mat;
maximumsCell{1,4} = maximums;
load 1\maximums\10\maximums39.mat;
maximumsCell{1,3} = maximums;
load 1\maximums\10\maximums48.mat;
maximumsCell{1,2} = maximums;
load 1\maximums\10\maximums75.mat;
maximumsCell{1,1} = maximums;

load 1\maximums\20\maximums3.mat;
maximumsCell{2,9} = maximums;
load 1\maximums\20\maximums6.mat;
maximumsCell{2,8} = maximums;
load 1\maximums\20\maximums9.mat;
maximumsCell{2,7} = maximums;
load 1\maximums\20\maximums12.mat;
maximumsCell{2,6} = maximums;
load 1\maximums\20\maximums15.mat;
maximumsCell{2,5} = maximums;
load 1\maximums\20\maximums27.mat;
maximumsCell{2,4} = maximums;
load 1\maximums\20\maximums39.mat;
maximumsCell{2,3} = maximums;
load 1\maximums\20\maximums48.mat;
maximumsCell{2,2} = maximums;
load 1\maximums\20\maximums75.mat;
maximumsCell{2,1} = maximums;

load 1\maximums\30\maximums3.mat;
maximumsCell{3,9} = maximums;
load 1\maximums\30\maximums6.mat;
maximumsCell{3,8} = maximums;
load 1\maximums\30\maximums9.mat;
maximumsCell{3,7} = maximums;
load 1\maximums\30\maximums12.mat;
maximumsCell{3,6} = maximums;
load 1\maximums\30\maximums15.mat;
maximumsCell{3,5} = maximums;
load 1\maximums\30\maximums27.mat;
maximumsCell{3,4} = maximums;
load 1\maximums\30\maximums39.mat;
maximumsCell{3,3} = maximums;
load 1\maximums\30\maximums48.mat;
maximumsCell{3,2} = maximums;
load 1\maximums\30\maximums75.mat;
maximumsCell{3,1} = maximums;

load 1\maximums\40\maximums3.mat;
maximumsCell{4,9} = maximums;
load 1\maximums\40\maximums6.mat;
maximumsCell{4,8} = maximums;
load 1\maximums\40\maximums9.mat;
maximumsCell{4,7} = maximums;
load 1\maximums\40\maximums12.mat;
maximumsCell{4,6} = maximums;
load 1\maximums\40\maximums15.mat;
maximumsCell{4,5} = maximums;
load 1\maximums\40\maximums27.mat;
maximumsCell{4,4} = maximums;
load 1\maximums\40\maximums39.mat;
maximumsCell{4,3} = maximums;
load 1\maximums\40\maximums48.mat;
maximumsCell{4,2} = maximums;
load 1\maximums\40\maximums75.mat;
maximumsCell{4,1} = maximums;

load 1\maximums\50\maximums3.mat;
maximumsCell{5,9} = maximums;
load 1\maximums\50\maximums6.mat;
maximumsCell{5,8} = maximums;
load 1\maximums\50\maximums9.mat;
maximumsCell{5,7} = maximums;
load 1\maximums\50\maximums12.mat;
maximumsCell{5,6} = maximums;
load 1\maximums\50\maximums15.mat;
maximumsCell{5,5} = maximums;
load 1\maximums\50\maximums27.mat;
maximumsCell{5,4} = maximums;
load 1\maximums\50\maximums39.mat;
maximumsCell{5,3} = maximums;
load 1\maximums\50\maximums48.mat;
maximumsCell{5,2} = maximums;
load 1\maximums\50\maximums75.mat;
maximumsCell{5,1} = maximums;


load 2\maximums\10\maximums3.mat;
maximumsCell2{1,9} = maximums;
load 2\maximums\10\maximums6.mat;
maximumsCell2{1,8} = maximums;
load 2\maximums\10\maximums9.mat;
maximumsCell2{1,7} = maximums;
load 2\maximums\10\maximums12.mat;
maximumsCell2{1,6} = maximums;
load 2\maximums\10\maximums15.mat;
maximumsCell2{1,5} = maximums;
load 2\maximums\10\maximums27.mat;
maximumsCell2{1,4} = maximums;
load 2\maximums\10\maximums39.mat;
maximumsCell2{1,3} = maximums;
load 2\maximums\10\maximums48.mat;
maximumsCell2{1,2} = maximums;
load 2\maximums\10\maximums75.mat;
maximumsCell2{1,1} = maximums;

load 2\maximums\20\maximums3.mat;
maximumsCell2{2,9} = maximums;
load 2\maximums\20\maximums6.mat;
maximumsCell2{2,8} = maximums;
load 2\maximums\20\maximums9.mat;
maximumsCell2{2,7} = maximums;
load 2\maximums\20\maximums12.mat;
maximumsCell2{2,6} = maximums;
load 2\maximums\20\maximums15.mat;
maximumsCell2{2,5} = maximums;
load 2\maximums\20\maximums27.mat;
maximumsCell2{2,4} = maximums;
load 2\maximums\20\maximums39.mat;
maximumsCell2{2,3} = maximums;
load 2\maximums\20\maximums48.mat;
maximumsCell2{2,2} = maximums;
load 2\maximums\20\maximums75.mat;
maximumsCell2{2,1} = maximums;

load 2\maximums\30\maximums3.mat;
maximumsCell2{3,9} = maximums;
load 2\maximums\30\maximums6.mat;
maximumsCell2{3,8} = maximums;
load 2\maximums\30\maximums9.mat;
maximumsCell2{3,7} = maximums;
load 2\maximums\30\maximums12.mat;
maximumsCell2{3,6} = maximums;
load 2\maximums\30\maximums15.mat;
maximumsCell2{3,5} = maximums;
load 2\maximums\30\maximums27.mat;
maximumsCell2{3,4} = maximums;
load 2\maximums\30\maximums39.mat;
maximumsCell2{3,3} = maximums;
load 2\maximums\30\maximums48.mat;
maximumsCell2{3,2} = maximums;
load 2\maximums\30\maximums75.mat;
maximumsCell2{3,1} = maximums;

load 2\maximums\40\maximums3.mat;
maximumsCell2{4,9} = maximums;
load 2\maximums\40\maximums6.mat;
maximumsCell2{4,8} = maximums;
load 2\maximums\40\maximums9.mat;
maximumsCell2{4,7} = maximums;
load 2\maximums\40\maximums12.mat;
maximumsCell2{4,6} = maximums;
load 2\maximums\40\maximums15.mat;
maximumsCell2{4,5} = maximums;
load 2\maximums\40\maximums27.mat;
maximumsCell2{4,4} = maximums;
load 2\maximums\40\maximums39.mat;
maximumsCell2{4,3} = maximums;
load 2\maximums\40\maximums48.mat;
maximumsCell2{4,2} = maximums;
load 2\maximums\40\maximums75.mat;
maximumsCell2{4,1} = maximums;

load 2\maximums\50\maximums3.mat;
maximumsCell2{5,9} = maximums;
load 2\maximums\50\maximums6.mat;
maximumsCell2{5,8} = maximums;
load 2\maximums\50\maximums9.mat;
maximumsCell2{5,7} = maximums;
load 2\maximums\50\maximums12.mat;
maximumsCell2{5,6} = maximums;
load 2\maximums\50\maximums15.mat;
maximumsCell2{5,5} = maximums;
load 2\maximums\50\maximums27.mat;
maximumsCell2{5,4} = maximums;
load 2\maximums\50\maximums39.mat;
maximumsCell2{5,3} = maximums;
load 2\maximums\50\maximums48.mat;
maximumsCell2{5,2} = maximums;
load 2\maximums\50\maximums75.mat;
...
% and #2
    ...
    nMSE(index,:) = trainus(X_1,ys_1,X_1,ys_1,OO1,GR1,maximumsCell{i,j});
    nMSE2(index,:) = trainus(X_2,ys_2,X_2,ys_2,OO2,GR2,maximumsCell2{i,j});
