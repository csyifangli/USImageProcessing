...
featCells{1,1} = load('E:\data\claudio\1\features\Grid039Circle50.txt');


featCells{2,1} = load('E:\data\claudio\2\features\Grid039Circle50.txt');
...
% and #2
nMSE = trainus(X_1,ys_1,X_1,ys_1,OO1,GR1);
nMSE2 = trainus(X_2,ys_2,X_2,ys_2,OO2,GR2);
