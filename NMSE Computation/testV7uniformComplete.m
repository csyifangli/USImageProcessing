...
%%
featCells = cell(1,4);
featCells{1,4} = load('E:\data\claudio\1\features\Grid027Circle50.txt');
featCells{1,3} = load('E:\data\claudio\1\features\Grid039Circle50.txt');

featCells{1,2} = load('E:\data\claudio\1\features\Grid027Circle10.txt');
featCells{1,1} = load('E:\data\claudio\1\features\Grid039Circle10.txt');
