...
featCells = cell(1,5);
featCells{5} = load('E:\data\claudio\1\features\Grid543Circle50.txt');
featCells{4} = load('E:\data\claudio\1\features\Grid543Circle40.txt');
featCells{3} = load('E:\data\claudio\1\features\Grid543Circle30.txt');
featCells{2} = load('E:\data\claudio\1\features\Grid543Circle20.txt');
featCells{1} = load('E:\data\claudio\1\features\Grid543Circle10.txt');
