...
featCells = cell(1,9);
featCells{9} = load('E:\data\claudio\2\features\Grid003Circle40.txt');
featCells{8} = load('E:\data\claudio\2\features\Grid006Circle40.txt');
featCells{7} = load('E:\data\claudio\2\features\Grid009Circle40.txt');
featCells{6} = load('E:\data\claudio\2\features\Grid012Circle40.txt');
featCells{5} = load('E:\data\claudio\2\features\Grid015Circle40.txt');
featCells{4} = load('E:\data\claudio\2\features\Grid027Circle40.txt');
featCells{3} = load('E:\data\claudio\2\features\Grid039Circle40.txt');
featCells{2} = load('E:\data\claudio\2\features\Grid048Circle40.txt');
featCells{1} = load('E:\data\claudio\2\features\Grid075Circle40.txt');
...
function nMSE = trainus(Xt,yt,Xp,yp,tset,pset)
