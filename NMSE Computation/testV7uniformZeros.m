...
%%
featCells = cell(1,8);
featCells{1,8} = load('E:\data\claudio\1\features\Grid003Circle50.txt');
featCells{1,7} = load('E:\data\claudio\1\features\Grid015Circle50.txt');
featCells{1,6} = load('E:\data\claudio\1\features\Grid075Circle50.txt');
featCells{1,5} = load('E:\data\claudio\1\features\Grid543Circle50.txt');

featCells{1,4} = load('E:\data\claudio\1\features\Grid003Circle10.txt');
featCells{1,3} = load('E:\data\claudio\1\features\Grid015Circle10.txt');
featCells{1,2} = load('E:\data\claudio\1\features\Grid075Circle10.txt');
featCells{1,1} = load('E:\data\claudio\1\features\Grid543Circle10.txt');
...
% and #2
trainus(X_1,ys_1,X_1,ys_1,OO1,GR1);
...
lambda = 1;
lab={'Thumb','Index','Middle','Ring','Little'};
d = size(Xt,2);
figure
