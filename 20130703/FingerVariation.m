...
switch setplots
    case 1
        if ~exist('xlsfile', 'var')
            xlsfile = 'D:\Ultrasound_Images\EXCEL\0704-Nonzeros.xls';
            textSup = 'Training in complete On-Off, testing in activation Graded. Stimulus';
            
        end
        plotaxis = [1 10 0 0.40];
    case 2
        if ~exist('xlsfile', 'var')
            xlsfile = 'D:\Ultrasound_Images\EXCEL\0704-Zeros.xls';
            textSup = 'Training in complete On-Off, testing in non-activation Graded. Stimulus';
        end
        plotaxis = [1 10 0 0.40];
    case 3
        if ~exist('xlsfile', 'var')
            xlsfile = 'D:\Ultrasound_Images\EXCEL\0704-Complete.xls';
            textSup = 'Training in complete On-Off, testing in complete Graded. Stimulus';
        end
        plotaxis = [1 10 0 0.40];
    ...
    case 4
        if ~exist('xlsfile', 'var')
            xlsfile = 'D:\Ultrasound_Images\EXCEL\0712-NonzerosF.xls';
            textSup = 'Training in complete On-Off, testing in activation Graded. Force in Newtons';
            
        end
        plotaxis = [1 10 0 5];
    case 5
        if ~exist('xlsfile', 'var')
            xlsfile = 'D:\Ultrasound_Images\EXCEL\0712-ZerosF.xls';
            textSup = 'Training in complete On-Off, testing in non-activation Graded. Force in Newtons';
        end
        plotaxis = [1 10 0 5];
    case 6
        if ~exist('xlsfile', 'var')
            xlsfile = 'D:\Ultrasound_Images\EXCEL\0712-CompleteF.xls';
            textSup = 'Training in complete On-Off, testing in complete Graded. Force in Newtons';
        end
        plotaxis = [1 10 0 5];
        
    case 7
        if ~exist('xlsfile', 'var')
            xlsfile = 'D:\Ultrasound_Images\EXCEL\0712-Nonzeros.xls';
            textSup = 'Training in complete On-Off, testing in activation Graded. Force in %';
        end
        plotaxis = [1 10 0 0.40];
    case 8
        if ~exist('xlsfile', 'var')
            xlsfile = 'D:\Ultrasound_Images\EXCEL\0712-Zeros.xls';
            textSup = 'Training in complete On-Off, testing in non-activation Graded. Force in %';
        end
        plotaxis = [1 10 0 0.40];
    case 9
        if ~exist('xlsfile', 'var')
            xlsfile = 'D:\Ultrasound_Images\EXCEL\0712-Complete.xls';
            textSup = 'Training in complete On-Off, testing in complete Graded. Force in %';
        end
        plotaxis = [1 10 0 0.40];
end

positionaxis = [0.8563    0.0585    0.1610    0.1910];  %Of the legend in the figures
mat = cell(1,6);
